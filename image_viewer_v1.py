...
if __name__ == '__main__':
    ...
    images.append(Image.create_procedural('brick'))
    ...
    images.append(Image.create_procedural('grass'))
    images.append(Image.create_procedural('colorwheel'))
    images.append(Image.create_procedural('gravel'))
